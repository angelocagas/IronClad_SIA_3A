...
.container{
 ...
 <div class="card-header">
     ...
     <h3 class="text-dark" style="font-family:bold">  <i class="fa fa-list" style="font-size:35px">   Driver List </i></h3>   
...
<div class="row">
               ...
               <div class="card-body">
                    ...
                    <tr>
                         ...
                         <th style="font-family: Arial"class="table-dark">Driver's Name</th>
                         <th style="font-family: Arial"class="table-dark"> License Number</th>
                         <th style="font-family: Arial"class="table-dark">License Expiry Number</th>
                         <th style="font-family: Arial"class="table-dark">Phone Number</th>
                         <th style="font-family: Arial"class="table-dark">Email</th>
                         <th style="font-family: Arial"class="table-dark">Assigned Carrier</th>
               ...
               <tbody>
                    ...
                    ?>
                              <tr>
                                   ...
                                   <td style="font-family: arial; color:#21130d"><?php echo $dlnum; ?></td>
                                   <td style="font-family: arial; color:#21130d"><?php echo $dlenum; ?></td>
                                   <td style="font-family: arial; color:#21130d"><?php echo $phone; ?></td>
                                   <td style="font-family: arial; color:#21130d"><?php echo $email; ?></td>
                                   <td style="font-family: arial; color:#21130d"><?php echo $acarrier; ?></td>
                    <?php
                         }

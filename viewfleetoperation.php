      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Fleet Operation</h4>           
<!--dito yung table-->
               ...
               <tbody>
                    ...
                    ?>
                              <tr>
                                  ...
                                  <td><button id="<?php echo $id ?>"onclick="window.location.href='managefleet.php'" type="button" class="btn btn-primary" action="managefleet.php">Edit</button></td>
                    <?php
                         }

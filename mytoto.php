...
if(isset($_POST['submit'])){
   ...
   $select = $pdo_conn->prepare("SELECT * FROM `admintb` WHERE username = ? AND password = ?");
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">MyToTo</span>
                </a>
              </div>
              <!-- /Logo -->

      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Layouts -->
            <li class="menu-item">
            <a href="driver.php" class="menu-link">
            ...
            <li class="menu-item active">
              <a href="checkpoint.php" class="menu-link">
               ...
               <tbody>
                    ...
                    ?>
                              <tr>
                                   ...
                                   <td><?php echo $checkstat; ?></td>
                                   <td><?php echo $checktime; ?></td>
                                   <td><?php echo $opname; ?></td>
                                   <td><?php echo $availstat; ?></td>
                                   <td><?php echo $mainstat; ?></td>
                                  <td><button id="<?php echo $id ?>"onclick="window.location.href='managecheckpoint.php'" type="button" class="btn btn-primary" action="managecheckpoint.php">Edit</button></td>
                    <?php
                         }

...
<div class="card-header">
     <br>
     <h3 class="text-dark" style="font-family:bold">  <i class="fa fa-address-book" style="font-size:35px">  Manage Checkpoint List </i></h3>  
...
<button style="font-family: bold; font-size:18px; width:10%" class="btn btn-dark my-3 "><a href="dashboard.php" class="text-light">Back</a></button> 
    <button style="font-family: bold; font-size:18px;" class="bt btn btn-dark my-3"><a href="addcheckpoint.php" class="text-light">Add</a></button> 
    <div class="row">
...
<div class="card-body">
                    ...
                    <th style="font-family: Arial"class="table-dark">ID</th>
                         ...
                         <th style="font-family: Arial"class="table-dark">Operator Name</th>
                         <th style="font-family: Arial"class="table-dark">Available Status</th>
                         <th style="font-family: Arial"class="table-dark">Maintenance Status</th>
               ...
               <tbody>
                    ...
                    ?>
                              ...
                              <td style="font-family: arial; color:#21130d"><?php echo $id; ?></td>
                                   ...
                                   <td><button id="<?php echo $id ?>"onclick="window.location.href='deletecheckpoint.php'" name="deletecheckpoint" type="button" action="deletecheckpoint.php"class="btn btn-danger">Delete<span class="las la-arrow-right"></span></button></td>
                                   <td><input value="Update"type="button" id="<?php echo $id ?>"onclick="window.location.href='updatecheckpoint.php'" name="Update" type="button" action="updatecheckpoint.php"class="btn btn-primary btn1"><span class="las la-arrow-right"></span></input></td>

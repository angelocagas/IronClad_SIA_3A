               ...
               <tbody>
                    ...
                    ?>
                              <tr>
                                  ...
                                  <td><button id="<?php echo $id ?>"onclick="window.location.href='Manage-Drivers.php'" type="button" class="btn btn-primary" action="Manage-Drivers.php">Edit</button></td>
                    <?php
                         }

...
if(isset($_POST['delete'])){
     header('location:checkpointstatus.php');  
}
?>
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item ">
              <a href="viewrequest.php" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Request Record
                </div>
              </a>
            </li>
            <li class="menu-item ">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">Archie De Jesus</span>
...
.container{
 ...
 <div class="card-header">
     ...
     <h3 class="text-dark" style="font-family:bold">  <i class="fa fa-list" style="font-size:35px">   Checkpoint List </i></h3>   

        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="dashboard.php" class="app-brand-link">
              ...
              <SPAN STYLE="font-size:8mm"><span class="demo menu-text fw-bolder ms-2">Mytoto</span></SPAN>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text">Back to Dashboard</span>
            </li>
            <li class="menu-item">
              <a href="mytotoout.php" class="menu-link">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="mb-3 row">
                      ...
                      <div class="mb-3 row">
                      <label for="html5-text-input" class="col-md-2 col-form-label">Activity</label>
                        <div class="col-md-10">
                        <select id="defaultSelect" class="form-select" name="activity">
                          <option>Select an Activity</option>
                          <option value="Time On">Time On</option>
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                          <input readonly class="form-control" type="text" value=" <?=$_SESSION['username']?> " id="encoder" name="username"/>
                        </div>
                      </div>
                      <button type="submit" class="btn btn-primary" name="submit">Punch In</button>
                      <br></br>
                  ...
                  <table class="table table-hover">
                    ...
                    $sql = "SELECT * FROM `mytoto` WHERE `date` = CURRENT_DATE()";
